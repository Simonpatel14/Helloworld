...
public class VariablesAndMethods {     // Mehtod and class don't end with ; only syntax end with ;

    //instance variable-variable declared inside class but Outside method or constructor eg a and b
